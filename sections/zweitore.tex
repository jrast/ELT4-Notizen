...
\input{tikzPictures/zweitore/UUebersetzungRueck.tex}\\
\begin{align}
...
\textbf{Bsp} \input{tikzPictures/zweitore/BetriebsEingangsImped.tex}\\
...
\input{tikzPictures/zweitore/BetriebsSpannungsUebersetzung.tex}\\
\begin{align}
...
\end{align}
\input{tikzPictures/zweitore/BetriebsSpannungsUebersetzung2.tex}\\
...
\subfloat[Falsche Parallelschaltung]{
	\input{tikzPictures/zweitore/RegelvBrunFalsch.tex}
	\label{fig:zweitor:regelvbrun:falsch}
}
\qquad
\subfloat[Richtige Parallelschaltung]{
	\input{tikzPictures/zweitore/RegelvBrunRichtig.tex}
...
\subfloat[Reziprozität]{
	\input{tikzPictures/zweitore/ReziLinks.tex}
	\label{fig:zweitor:rezi:links}
}
\qquad
\subfloat[Reziprozität]{
	\input{tikzPictures/zweitore/ReziRechts.tex}
...
\end{align}
\textbf{Beispiel}
% \input{tikzPictures/zweitore/ReziBspLinks.tex}
% \input{tikzPictures/zweitore/ReziBspRechts.tex}
\begin{figure}[!h]
\centering
\subfloat[]{
	\input{tikzPictures/zweitore/ReziBspLinks.tex}
