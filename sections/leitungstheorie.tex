...
\begin{figure}[!h]
	\centering
	\input{tikzPictures/leitungstheorie/LeitungZweitor.tex}
...
\begin{figure}[!h]
	\centering
 	\input{tikzPictures/leitungstheorie/asdffdsa.tex}
...
\centering
\subfloat[Z-Ebene]{
	\input{tikzPictures/leitungstheorie/SmithZRZ.tex}
	\label{fig:leitungstheorie:smith:zrz}
}
\qquad
\subfloat[R-Ebene]{
	\input{tikzPictures/leitungstheorie/SmithZRR.tex}
