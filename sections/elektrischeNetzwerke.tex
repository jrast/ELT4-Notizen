...
\begin{figure}[!ht]
\begin{center}
  \input{./tikzPictures/elektrischeNetzwerke/ZeigerDiagrammFallunterscheidung}
...
\begin{figure}[!ht]
\begin{center}
  \input{./tikzPictures/elektrischeNetzwerke/PolstellenZusammenhang}
...
\begin{figure}[!ht]
\begin{center}
  \input{./tikzPictures/elektrischeNetzwerke/ZusammenhangPNFrequenz}
