...
\hline
\parbox[c][1.5cm]{4.2cm}{\input{tikzPictures/RET/L.tex}} & L-Typ &
L-Kreis & L-Trennbündel & Nullstelle & Polstelle\\
\hline
\parbox[c][1.5cm]{4.2cm}{\input{tikzPictures/RET/C.tex}} & C-Typ &
C-Kreis & C-Trennbündel & Polstelle & Nullstelle\\
\hline
\parbox[c][1.5cm]{4.2cm}{\input{tikzPictures/RET/LCSer.tex}} & S-Typ &
C-Trennbündel & L-Trennbündel & Polstelle & Polstelle\\
\hline
\parbox[c][1.5cm]{4.2cm}{\input{tikzPictures/RET/LCPar.tex}} & P-Typ &
...
\subfloat[C-Klemmentrennbündel]{
	\input{tikzPictures/RET/Trennbuendel.tex}
	\label{fig:ret:klemmenbuendel}
}
\qquad
\subfloat[C-Klemmenkreis]{
	\input{tikzPictures/RET/Klemmenkreis.tex}
...
\begin{align}
	...
	\underline{Y}_1(p)&=\left(16p+12p^3+2p^5\right):\left(\frac{7}{4}p^2+\frac{5}{8}p^4\right)=\frac{65}{7p}+\frac{\frac{44}{7}p^3+2p^5}{\frac{7}{4}p^2+\frac{5}{8}p^4}\nonumber\\
...
\end{align}
%TODO: Bildli einfügen. He is the motherfucking pterodactyl!
