...
\hline
\parbox[c][1.5cm]{4.5cm}{\input{tikzPictures/RET/L.tex}} & L-Typ &
L-Klemmenkreis & L-Klemmentrennbündel\\
& & Nullstelle bei $\omega = 0$ & Pol bei $\omega \rightarrow \infty$ \\
\hline
\parbox[c][1.5cm]{4.5cm}{\input{tikzPictures/RET/C.tex}} & C-Typ &
C-Klemmenkreis & C-Klemmentrennbündel\\
& & Nullstelle bei $\omega \rightarrow \infty$ & Pol bei $\omega \rightarrow
0$\\
\hline
\parbox[c][1.5cm]{4.5cm}{\input{tikzPictures/RET/LCSer.tex}} & S-Typ &
C-Klemmentrennbündel & L-Klemmentrennbündel\\
\hline
\parbox[c][1.5cm]{4.5cm}{\input{tikzPictures/RET/LCPar.tex}} & P-Typ &
