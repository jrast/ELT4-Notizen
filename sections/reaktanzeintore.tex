...
\begin{tabular}{llll}
\input{tikzPictures/RET/L.tex} & L-Typ & L-Klemmenkreis & L-Klemmentrennbündel\\
& & Nullstelle bei $\omega = 0$ & Pol bei $\omega \rightarrow \infty$ \\
\input{tikzPictures/RET/C.tex} & C-Typ & C-Klemmenkreis & C-Klemmentrennbündel\\
& & Nullstelle bei $\omega \rightarrow \infty$ & Pol bei $\omega \rightarrow
0$\\
\input{tikzPictures/RET/LCSer.tex} & S-Typ & C-Klemmentrennbündel &
L-Klemmentrennbündel\\
\input{tikzPictures/RET/LCPar.tex} & P-Typ & C-Klemmenkreis & L-Klemmenkreis\\
\end{tabular}
