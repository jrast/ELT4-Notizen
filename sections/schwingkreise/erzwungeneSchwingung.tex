...
\begin{align}
	...
	\frac{\underline{Z}}{R} =
	\frac{j\omega\frac{1}{\omega_rQ}}{1+\frac{\omega}{\omega_r}\frac{1}{Q}+(j\omega)^2\frac{1}{\omega_r^2}}\nonumber\\
	\frac{}{}\nonumber\\
...
\begin{align}
 	\frac{\underline{Z}}{R} = \frac{1}{1+j\eta Q},\ \Omega=\eta Q \text{normierte
 	Frequenz}\nonumber\\
%  	\frac{\underline{Z}}{R} = \frac{1}{1+j\Omega} = \frac{1}{\sqrt{1+\Omega^2}}\arc
%  	\arctan\Omega \text{normierter Frequenzgang}\nonumber
%TODO irgendwo hier hats ein Problem. Findet Walter!
\end{align}
...
%Bildli Serie Uwellig Seriell L-R-C; U,I,L,G=1/R,C
\begin{align}
	\underline{Y} = \frac{1}{\frac{1}{G}+j\omega L+\frac{1}{j\omega C}} =
	\frac{G}{1+j(\omega L-\frac{1}{\omega C})G}\nonumber
\end{align}\\
Folgende Grössen sind dual (vgl. Parallelschwingkreis)\\
\begin{align}
...
\underline{I_L} \leftrightarrow \underline{I_C}\nonumber
\end{align}\\
$\rightarrow$ sämtliche hergeleiteten Beziehungen gelten "`dual"' auch für den
Serieschwingkreis\\
Beispiel: Parallel-SK $Q_P=R\sqrt{\frac{C}{L}}$\\
Serie-SK $Q_S=G\sqrt{\frac{L}{C}}=\frac{1}{R}\sqrt{\frac{L}{C}}$\\
%Nüübuur Skript seite 26 wie man von LR Serie zu L'R' Parallel kommt